...
//#region node_modules/.nitro/vite/services/ssr/assets/router-B_kqZxno.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-B5yaUP6u.css";
...
var $$splitComponentImporter = () => import("./routes-3RgmUKfi.mjs");
var rootRouteChildren = { IndexRoute: createFileRoute("/")({
	head: () => ({ meta: [
		{ title: "Fetchz — Download videos & audio from Twitter, Pinterest, Instagram, YouTube" },
		{
			name: "description",
			content: "Fetchz is the fastest way to save videos and audio from Twitter, Pinterest, Instagram and YouTube. Paste a link, pick a format, download in seconds."
		},
		{
			property: "og:title",
			content: "Fetchz — Save any video or audio, instantly"
		},
		{
			property: "og:description",
			content: "One tool for Twitter, Pinterest, Instagram and YouTube. HD video, crisp MP3, no watermarks, no signup."
		},
		{
			property: "og:type",
			content: "website"
